      ...
      <div className="w-[320px] bg-white shadow p-4 flex flex-col gap-4 rounded-2xl">
        ...
        {/* Progress Bar */}
          ...
          <div className="flex flex-col gap-3 bg-gray-50 p-3 rounded-lg h-80">
            ...
            <p className="text-gray-700 text-xs">Application ID:</p>

            <p className="text-gray-700 text-xs">APP-2025-0001</p>

            <p className="text-black text-sm font-medium">
              <span>📅</span> February 12, 2025
            </p>

            <p className="text-gray-700 text-xs">Estimated Completion</p>

            <p className="text-black text-sm font-medium ">Jane Lim</p>

            <p className="text-gray-700 text-xs">Current Officer</p>

            <p className="text-black text-sm font-medium ">
              <span>⏰</span> 05/02/2025
            </p>

            <p className="text-gray-700 text-xs ">Next Milestone</p>
