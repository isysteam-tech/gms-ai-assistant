...
<div className="min-h-screen bg-white p-4 flex flex-col gap-6">
  ...
  <div className="flex items-start justify-between">
    ...
    <RxQuestionMarkCircled 
      className="text-gray-700 text-4xl bg-white rounded-full p-2 shadow"
    />
...
<path d="M4.35464 9.44125L10.1865 1.95551C10.6426 1.37006 11.4975 1.73445 11.4975 2.51431V8.30837C11.4975 8.7755 11.8328 9.15425 12.2463 9.15425H15.0828C15.7273 9.15425 16.0708 10.0125 15.645 10.5589L9.81317 18.0447C9.35709 18.6301 8.50217 18.2657 8.50217 17.4858V11.6918C8.50217 11.2247 8.1669 10.8459 7.75334 10.8459H4.9168C4.27243 10.8459 3.92895 9.98767 4.35464 9.44125Z" stroke="white" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
      Switch To Form
    </Button>
  </div>
...
<div className="flex flex-col justify-center items-center p-4">
  <img src={abstractLogo} alt="Abstract Logo" className="w-22 h-22 object-contain" />
      <h1 className="text-black text-2xl font-bold">
  Welcome To The GMS InTake Assistant
  </h1>
      <p className="text-gray-700 text-sm mt-2">
   Choose A Task To Begin, You Can Switch Between Chat And Forms AnyTime.
      </p>
</div>
...
Document Coach
  ...
  <div className="flex items-center gap-2">
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M6 12C6 11.3096 6.55964 10.75 7.25 10.75H7.25897C7.94933 10.75 8.50897 11.3096 8.50897 12C8.50897 12.6904 7.94933 13.25 7.25897 13.25H7.25C6.55964 13.25 6 12.6904 6 12ZM10.7456 12C10.7456 11.3096 11.3052 10.75 11.9956 10.75H12.0045C12.6949 10.75 13.2545 11.3096 13.2545 12C13.2545 12.6904 12.6949 13.25 12.0045 13.25H11.9956C11.3052 13.25 10.7456 12.6904 10.7456 12ZM15.4911 12C15.4911 11.3096 16.0507 10.75 16.7411 10.75H16.75C17.4404 10.75 18 11.3096 18 12C18 12.6904 17.4404 13.25 16.75 13.25H16.7411C16.0507 13.25 15.4911 12.6904 15.4911 12Z" fill="#FB3748"/>
<path opacity="0.4" fill-rule="evenodd" clip-rule="evenodd" d="M17 3C17 2.44772 17.4477 2 18 2C19.913 2 21.231 3.73702 21.231 5.57143C21.231 5.7037 21.2308 5.83139 21.2305 5.95493C21.2286 6.92941 21.2271 7.64598 21.3561 8.31957C21.4902 9.02032 21.7711 9.67768 22.4286 10.4355C23.1905 11.3136 23.1905 12.6864 22.4286 13.5645C21.7711 14.3223 21.4902 14.9797 21.3561 15.6804C21.2271 16.354 21.2286 17.0706 21.2305 18.045C21.2308 18.1686 21.231 18.2963 21.231 18.4286C21.231 20.263 19.913 22 18 22C17.4477 22 17 21.5523 17 21C17 20.4477 17.4477 20 18 20C18.5513 20 19.231 19.4345 19.231 18.4286C19.231 18.3009 19.2306 18.1735 19.2302 18.0463C19.2271 17.1055 19.224 16.1805 19.3917 15.3044C19.5932 14.2517 20.0334 13.2733 20.9179 12.2538C21.0274 12.1277 21.0274 11.8723 20.9179 11.7462C20.0334 10.7267 19.5932 9.74823 19.3917 8.69554C19.224 7.81947 19.2271 6.89448 19.2302 5.95367C19.2306 5.82652 19.231 5.69908 19.231 5.57143C19.231 4.56552 18.5513 4 18 4C17.4477 4 17 3.55229 17 3Z" fill="#FB3748"/>
<path opacity="0.4" fill-rule="evenodd" clip-rule="evenodd" d="M7 3C7 2.44772 6.55228 2 6 2C4.08695 2 2.76897 3.73702 2.76897 5.57143C2.76897 5.63284 2.76899 5.69342 2.76902 5.7532C2.76989 7.94318 2.77033 9.05366 1.57139 10.4355C0.809534 11.3136 0.809536 12.6864 1.5714 13.5645C2.22892 14.3223 2.50982 14.9797 2.64394 15.6804C2.77287 16.354 2.77143 17.0706 2.76947 18.045C2.76923 18.1686 2.76897 18.2963 2.76897 18.4286C2.76897 20.263 4.08695 22 6 22C6.55228 22 7 21.5523 7 21C7 20.4477 6.55228 20 6 20C5.44872 20 4.76897 19.4345 4.76897 18.4286C4.76897 18.3009 4.76939 18.1735 4.76981 18.0463C4.77291 17.1055 4.77596 16.1805 4.60829 15.3044C4.4068 14.2517 3.96658 13.2733 3.08206 12.2538C2.97265 12.1277 2.97265 11.8723 3.08206 11.7462C4.77803 9.79147 4.77405 7.98584 4.76945 5.90134C4.76921 5.79216 4.76897 5.68221 4.76897 5.57143C4.76897 4.56552 5.44872 4 6 4C6.55228 4 7 3.55229 7 3Z" fill="#FB3748"/>
</svg>
...
<div className="w-[775px] h-[110px] p-2 -ml-7">
  ...
  By selecting a feature, it will make your goal easier to achieve
    ...
    <div className="absolute bottom-2 left-3 flex gap-2">
      {/* Circle 1 */}
      <div className="h-6 w-[101px] rounded-full p-[1px] 
      ...
      {/* Circle 3 */}
      <div className="h-6 w-[147px] rounded-full p-[1px] 
          bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 flex items-center justify-center">
        <div className="h-full w-full bg-white rounded-full flex items-center justify-center text-black text-xs font-medium px-2  whitespace-nowrap">
